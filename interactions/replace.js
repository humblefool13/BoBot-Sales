  ...
  async interact(client, interaction) {
    try {
      ...
      if (!find.length)
        return interaction.editReply({
          embeds: [
            MakeEmbed("You do not have an active configuration to replace."),
          ],
          ephemeral: true,
        });
      let big = false;
      ...
      const filter = (interaction) =>
        interaction.customId === "subs" && interaction.user.id === userid;
      ...
      client.users.cache
        ...
        .send(`${client.user.username} has trouble in replace.js -\n\n${e}`);
    }
  },
};
